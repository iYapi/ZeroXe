# Form implementation generated from reading ui file 'app/ui/modules/special_case/comp_saveas.ui'
#
...
"")
        ...
        self.verticalWidget_target = QtWidgets.QWidget(parent=Form)
        self.verticalWidget_target.setEnabled(True)
        self.verticalWidget_target.setStyleSheet(".QListWidget {\n"
"border-radius: 5%;\n"
"border: 1px solid black;\n"
"}\n"
"")
        self.verticalWidget_target.setObjectName("verticalWidget_target")
        self.verticalLayout_version = QtWidgets.QVBoxLayout(self.verticalWidget_target)
        self.verticalLayout_version.setObjectName("verticalLayout_version")
        self.label_source = QtWidgets.QLabel(parent=self.verticalWidget_target)
        self.label_source.setObjectName("label_source")
        self.verticalLayout_version.addWidget(self.label_source)
        self.label_sourceName = QtWidgets.QLabel(parent=self.verticalWidget_target)
        self.label_sourceName.setObjectName("label_sourceName")
        self.verticalLayout_version.addWidget(self.label_sourceName)
        self.line_2 = QtWidgets.QFrame(parent=self.verticalWidget_target)
        self.line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_2.setObjectName("line_2")
        self.verticalLayout_version.addWidget(self.line_2)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_version.addItem(spacerItem1)
        self.gridLayout_main.addWidget(self.verticalWidget_target, 1, 2, 1, 1)
        ...
        self.gridLayout_function.addItem(spacerItem2, 1, 0, 1, 2)
        self.pushButton_target = QtWidgets.QPushButton(parent=Form)
        self.pushButton_target.setStyleSheet(".QPushButton {\n"
"    border: none;\n"
...
"}")
        ...
        self.gridLayout_function.addWidget(self.pushButton_target, 6, 0, 1, 2)
...
"}")
        ...
        self.pushButton_source = QtWidgets.QPushButton(parent=Form)
        self.pushButton_source.setObjectName("pushButton_source")
        self.gridLayout_function.addWidget(self.pushButton_source, 5, 0, 1, 2)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_sourceName.setText(_translate("Form", "..."))
        self.pushButton_target.setText(_translate("Form", "Generate"))
        self.toolButton_blenderPath.setText(_translate("Form", "Locate"))
        self.label_blenderPath.setText(_translate("Form", "Blender"))
        self.pushButton_source.setText(_translate("Form", "Source"))
